...
mixin _$TiendaStore on _TiendaStore, Store {
  ...
  final _$filterProductServiceResultsAsyncAction =
      AsyncAction('_TiendaStore.filterProductServiceResults');

  @override
  Future<dynamic> filterProductServiceResults(
      List<bool> products, List<bool> services, List<bool> serviceClient) {
    return _$filterProductServiceResultsAsyncAction.run(() =>
        super.filterProductServiceResults(products, services, serviceClient));
  }
